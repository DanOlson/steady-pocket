use crate::{
    db::Db,
    models::{
        Budget, CreateBudget, CreateExpenditure, CreateExpenseCategory, Expenditure,
        ExpenseCategory, UpdateBudget, UpdateExpenditure, UpdateExpenseCategory,
    },
    prelude::*,
};
...
pub trait Repository {
    ...
    async fn update_expense_category(&self, id: i32, category: UpdateExpenseCategory)
        -> Result<()>;
